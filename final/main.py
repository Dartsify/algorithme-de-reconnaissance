...
MODEL_PATH = PROJECT_ROOT / "dartsify_ai_final.pkl"
...
MIN_DART_CONTOUR_AREA = 30 # Seuil d'aire pour filtrer les contours de fléchettes valides avec les fausses détections
...
def ouvrir_une_camera(camera_id):
	...
	if cap.isOpened():
		# Forcer la résolution aide le backend à se stabiliser
...
def main() -> None:
	...
	print("Chargement des homographies...")
	homographies = charger_homographies(HOMOGRAPHY_FILE)
	print("Ouverture des caméras...Environ 30 secondes. Merci de patienter...")
	cameras = ouvrir_cameras() # 40 secondes c'est trop (à optimiser plus tard)
